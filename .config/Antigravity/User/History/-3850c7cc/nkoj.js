...
// Since the main server export doesn't directly expose McpServer,
// we need to access it differently. Let's check what's available:
const serverModule = require('@modelcontextprotocol/sdk/server');

// Check what's in the server module
console.log('Server module exports:', Object.keys(serverModule));

// Import the McpServer specifically
const McpServer = require('@modelcontextprotocol/sdk/dist/cjs/server/mcp.js').McpServer;
