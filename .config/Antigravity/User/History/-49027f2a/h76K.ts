...
import { formatHostForUrl } from './ip';
...
export const wg = {
  generateServerPeer: (
    ...
    if (client.serverEndpoint) {
     extraLines.push(`Endpoint = ${formatHostForUrl(client.serverEndpoint)}`);
    }
...
Endpoint = ${formatHostForUrl(userConfig.host)}:${userConfig.port}`;
  },
