...
-- Zoxide plugin configuration (from example config)
-- Note: No official zoxide plugin exists for Yazi yet
-- You can use zoxide from command line: zi <dir>, z <dir>, etc.
-- require("zoxide"):setup({
--   update_db = false,
-- })

-- Session plugin configuration (from example config)
-- Session plugin not available - removed to prevent errors
